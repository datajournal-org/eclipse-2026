...
// footprints. The heavy geometry lives in corridor-compute.ts and is run once by scripts/build-corridor.ts,
...
export type { CorridorEdges } from './corridor-compute';
