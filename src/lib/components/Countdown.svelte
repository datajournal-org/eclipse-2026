...
<section class="block cd">
  {#if state === 'before'}
    <div class="units" aria-live="off">
      <div class="u"><span class="n tnum">{parts.d}</span><span class="l">{$t('countdown.d')}</span></div>
      <div class="u"><span class="n tnum">{pad(parts.h)}</span><span class="l">{$t('countdown.h')}</span></div>
      <div class="u"><span class="n tnum">{pad(parts.m)}</span><span class="l">{$t('countdown.m')}</span></div>
      <div class="u"><span class="n tnum">{pad(parts.s)}</span><span class="l">{$t('countdown.s')}</span></div>
    </div>
...
<style>
  ...
  .head { font-size: 1.4rem; font-weight: 800; color: var(--accent); }
  .since { margin-top: 6px; color: var(--muted); font-size: 0.92rem; }
</style>
