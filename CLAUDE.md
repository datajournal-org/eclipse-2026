...
serves directly (see `tests/publish.spec.ts` for the contract). All personalisation — chosen location, maps, countdown — runs client-side, and the chosen location
