...
export default ts.config(
	// Not linted: build output, SvelteKit cache, the old prototype, and the generated corridor data.
	{ ignores: ['.svelte-kit/', 'build/', 'prototype/', 'src/lib/shadow-globe/corridor.generated.ts'] },
